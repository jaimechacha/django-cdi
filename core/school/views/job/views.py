...
from core.school.forms import JobForm, Job
from core.security.mixins import  PermissionMixin


class JobListView(PermissionMixin, ListView):
    model = Job
...
class JobCreateView(PermissionMixin, CreateView):
    model = Job
...
class JobUpdateView(PermissionMixin, UpdateView):
    model = Job
    template_name = 'job/create.html'
    form_class = JobForm
    success_url = reverse_lazy('job_list')
...
class JobDeleteView(PermissionMixin, DeleteView):
    model = Job
