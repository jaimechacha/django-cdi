    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_coupon', models.IntegerField(blank=True, default=0, null=True, verbose_name='Cupo máximo')),
                ('min_coupon', models.IntegerField(blank=True, default=0, null=True, verbose_name='Cupo mínimo')),
            ],
            options={
                'verbose_name': 'Curso',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gender', models.CharField(choices=[('masculino', 'Masculino'), ('femenino', 'Femenino')], default='masculino', max_length=10, verbose_name='Género')),
        ...
        migrations.AddField(
            model_name='contracts',
            name='shifts',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='school.Shifts', verbose_name='Turno'),
        ),
        migrations.AddField(
            model_name='contracts',
            name='teacher',
