...
function generateReport(all) {
    var parameters = {
        ...
        'conferencetheme': select_conferencetheme.val()
    };
...
$(function () {
    ...
    select_conferencetheme = $('select[name="conferencetheme"]');
    ...
    select_conferencetheme.on('change', function () {
        generateReport();
    });
